 ...
 */
class CI_DB_filebased_driver extends CI_DB {

    var $dbdriver = 'filebased';
...
/* End of file filebased_driver.php */
/* Location: ./system/database/drivers/filebased/filebased_driver.php */