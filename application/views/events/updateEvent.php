<div class="row well">
    ...
    <div class="col-lg-8 col-lg-offset-2">
        <form class="form-horizontal" role="form" method="post" accept-charset="utf-8" action="<?php echo site_url().'/events/doUpdateEvent/'. $event['id'] . '/' . $lang?>">
            ...
            <div class="form-group">
                <div class="col-lg-offset-2 col-lg-10">
                    ...
                    <?php
                        $url = site_url() . '/events/eventList/' . $lang . '/' . $year . '/' . $month;
