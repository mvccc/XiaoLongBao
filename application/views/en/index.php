        ...
        <div class="col-lg-4">
          <div class="panel panel-default mvccc-panel">
            <div class="panel-heading">
              <h3 class="panel-title"><span class="glyphicon glyphicon-globe"></span>&nbsp;Weekly Bible Verse</h3>
            </div>
            <div class="panel-body">
              ...
              <small><cite class="pull-right">John 3:16</cite></small>
            </div>
          </div>
        	<!--
        	<div class row>
    ...
    -->
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="panel panel-default mvccc-panel">
            <div class="panel-heading">
              <h3 class="panel-title"><span class="glyphicon glyphicon-home"></span>&nbsp;I am New</h3>
            </div>
            <div class="panel-body">
              <p>Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui. </p>
              <p><a class="btn btn-primary" href="#" role="button">Details &raquo;</a></p>
            </div>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="panel panel-default mvccc-panel">
            <div class="panel-heading">
              <h3 class="panel-title"><span class="glyphicon glyphicon-thumbs-up"></span>&nbsp;Recent Events</h3>
            </div>
            <div class="panel-body">
              <p>Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui. </p>
              <p><a class="btn btn-primary" href="#" role="button">Details &raquo;</a></p>
        ...
        <div class="col-lg-4">
          <div class="panel panel-default mvccc-panel">
            <div class="panel-heading">
              <h3 class="panel-title"><span class="glyphicon glyphicon-volume-up"></span>&nbsp;Sunday Messages</h3>
            </div>
            <div class="panel-body">
